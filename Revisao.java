...
public class Revisao {
    public static void main(String[] args) {
        ...
        while(stop == false){
            ...
            String contato = "";
            String viagem = "";
            System.out.println("Faremos algumas pergutas para o diagnóstisco, responda apenas com 'SIM' ou 'NAO'. ");
            while(contador <= 3){
            ...
            contador = 0;
            while(contador <= 3){
                System.out.println("Teve sintomas recentes? (SIM/NAO)");
            ...
            contador = 0;
            while(contador <= 3){
                System.out.println("Teve contato com pessoas infectadas? (SIM/NAO)");
            ...
            contador = 0;
            while(contador <= 3){
                System.out.println("Retornou recentemente de viagem? (SIM/NAO)");
